  ...
  return (
    <BodyLayout>
      ...
      <Alert destroy onClose={() => {}} type="success">
        Your changes were saved, you can now view your Buy with Prime button on
        Product page.
      </Alert>
        ...
        <Card title="About this integration">
          <FlexLayout direction="vertical">
            <TextStyles>
              ...
              fast,free delivery and 1-2 days
            </TextStyles>
        ...
        <FlexLayout spacing="loose" valign="center" halign="fill">
          ...
          <Card>
            <img
              ...
              src="https://static.wixstatic.com/media/c26d6fecf2f64eb3a34e3087d6e77281.jpg"
              alt=""
            />
          </Card>
        </FlexLayout>
      ...
      <Card>
        <FlexLayout halign="fill" valign="center" spacing="loose">
          ...
          <Button icon={<TextStyles>_ICON_</TextStyles>}>
            Connect to Amazon
          </Button>
        </FlexLayout>
      </Card>
